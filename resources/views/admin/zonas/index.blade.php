          ...
          <div class="box">
           @include('flash::message')
            <div class="box-header">
              <h3 class="box-title"><a href="{{url('admin/zonas/create/'.$torneo_id)}}" class="btn btn-success">Registrar nueva zona</a></h3> 
            </div>
            <!-- /.box-header -->
              ...
              <table class="table table-hover">
                ...
                @foreach($zonas as $zona)
                  <tr>
                        ...
                        <a href="{{ url('admin/posiciones/' . $zona->id )}}" title = 'Equipos' href="#" class="btn btn-info" onclick= "">
                          Tabla de posiciones
                        </a>
                      </td>
                    </tr>
